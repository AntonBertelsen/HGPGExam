...
public class LandingAreaAuthoring : MonoBehaviour
{
...
public class LandingAreaBaker : Baker<LandingAreaAuthoring>
{
    public override void Bake(LandingAreaAuthoring baker)
    {
        ...
        var filter = new CollisionFilter
        {
            ...
            CollidesWith = (uint)baker.obstacleLayerMask.value,
            GroupIndex = 0
        };
